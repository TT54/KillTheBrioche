...
public class FileManager {
    ...
    public static FileConfiguration getYmlFile(String fileName) {
        return YamlConfiguration.loadConfiguration(getYmlFile(fileName, KillTheBrioche.getInstance()));
    }

    public static FileConfiguration getYmlFile(String fileName, String dataFolder) {
        return YamlConfiguration.loadConfiguration(getYmlFile(fileName, dataFolder, KillTheBrioche.getInstance()));
    }

    public static void saveFile(FileConfiguration file, String fileName) {
        saveFile(KillTheBrioche.getInstance(), file, fileName);
    }
    ...
    public static void saveFile(FileConfiguration file, String fileName, String fileDataFolder) {
        try {
            file.save(getYmlFile(fileName, fileDataFolder, KillTheBrioche.getInstance()));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void write(String text, File file) {
        if (!file.exists())
            createFile(file.getAbsolutePath(), KillTheBrioche.getInstance());
        try {
